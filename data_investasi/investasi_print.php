 ...
 <head>
     ...
     <title>Laporan Aplikasi Financial Planner</title>
                 ...
                 <tbody>
                     <?php
                        ...
                        while ($d = mysqli_fetch_array($data)) {
                            ...
                            if ($d['transaksi_jenis'] == "Pemauskan") {
                     ...
                     <tr>
                         ...
                         <td colspan="2" class="text-center text-bold text-white bg-primary"><?php echo "Rp. " . number_format($total_pemasukan - $total_cicilan) . " ,-"; ?></td>
                     </tr>
                 </tbody>
             </table>
