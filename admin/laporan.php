  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Laporan (Pemasukan Pengeluaran & Cicilan) </h3>
          </div>
          <div class="box-body">
                  ...
                  <tbody>
                    ...
                    while ($d = mysqli_fetch_array($data)) {
                      ...
                      if ($d['transaksi_jenis'] == "Pemasukan") {
                        ...
                        $total_cicilan += $d['transaksi_nominal'];
                      }
                    ?>
                      <tr>
                    ...
                    <tr>
                      ...
                      <td colspan="2" class="text-center text-bold text-white bg-primary"><?php echo "Rp. " . number_format(($total_pemasukan - $total_pengeluaran) - $total_cicilan) . " ,-"; ?></td>
                    </tr>
                  </tbody>
                </table>
