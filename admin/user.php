...
<div class="content-wrapper">
  ...
  if (isset($_GET['alert'])) {
    if ($_GET['alert'] == "update") {
      echo "<div class='alert alert-success custom-alert'>Data Pengguna Berhasil di Update</div>";
    } else if ($_GET['alert'] == "gagalupdate") {
      echo "<div class='alert alert-danger custom-alert'>Data Pengguna Gagal di Update Password Tidak Boleh Kosong</div>";
    } else if ($_GET['alert'] == "insert") {
      echo "<div class='alert alert-success custom-alert'>Data Pengguna Berhasil di Tambah</div>";
    } else if ($_GET['alert'] == "gagalinsert") {
      echo "<div class='alert alert-danger custom-alert'>Data Pengguna Gagal di Tambah</div>";
    }
  }
  ?>
