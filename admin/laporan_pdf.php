...
while ($d = mysqli_fetch_array($data)) {
  ...
  if ($d['transaksi_jenis'] == "Cicilan") {
    $cicil = "Rp. " . number_format($d['transaksi_nominal']) . " ,-";
  } else {
    $cicil = "-";
  }
...
$pdf->Cell(41, 7, "Rp. " . number_format($total_cicilan) . " ,-", 1, 1, 'C');

$pdf->Cell(10, 0, '', 0, 1);

$pdf->Cell(150, 7, "SALDO", 1, 0, 'R');
$pdf->Cell(50, 7, "Rp. " . number_format(($total_pemasukan - $total_pengeluaran) - $total_cicilan) . " ,-", 1, 0, 'C');
