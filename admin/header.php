    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="tingkat.php">
              <i class="fa fa-folder"></i> <span>DATA TINGKAT</span>
            </a>
          </li>
          ...
          <li>
            <a href="surplus.php">
              <i class="fa fa-folder"></i> <span>DATA SURPLUS</span>
            </a>
          </li>
          ...
          <li>
            ...
            <a href="pensiun.php">
              <i class="fa fa-calculator"></i> <span>HITUNG PENSIUN</span>
            </a>
          </li>
          ...
          <li>
            <a href="anak.php">
              <i class="fa fa-calculator"></i> <span>HITUNG ANAK</span>
            </a>
          </li>
