  ...
  <section class="content">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-red">
        <div class="inner">
          <?php
          $tanggal = date('Y-m-d');
          $cicilan = mysqli_query($koneksi, "SELECT sum(transaksi_nominal) as total_cicilan FROM transaksi WHERE transaksi_jenis='Cicilan' and transaksi_tanggal='$tanggal'");
          $c = mysqli_fetch_assoc($cicilan);
          ?>

          <h4 style="font-weight: bolder"><?php echo "Rp. " . number_format($c['total_cicilan']) . " ,-" ?></h4>
          <p>Cicilan Hari Ini</p>
        </div>
        <div class="icon">
          <i class="ion ion-stats-bars"></i>
        </div>
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-red">
        <div class="inner">
          <?php
          $bulan = date('m');
          $cicilan = mysqli_query($koneksi, "SELECT sum(transaksi_nominal) as total_cicilan FROM transaksi WHERE transaksi_jenis='Cicilan' and month(transaksi_tanggal)='$bulan'");
          $c = mysqli_fetch_assoc($cicilan);
          ?>
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-red">
        <div class="inner">
          <?php
          $tahun = date('Y');
          $cicilan = mysqli_query($koneksi, "SELECT sum(transaksi_nominal) as total_cicilan FROM transaksi WHERE transaksi_jenis='Cicilan' and year(transaksi_tanggal)='$tahun'");
          $c = mysqli_fetch_assoc($cicilan);
          ?>

          <h4 style="font-weight: bolder"><?php echo "Rp. " . number_format($c['total_cicilan']) . " ,-" ?></h4>
          <p>Cicilan Tahun Ini</p>
        </div>
        <div class="icon">
          <i class="ion ion-stats-bars"></i>
        </div>
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-black">
        <div class="inner">
          <?php
          $cicilan = mysqli_query($koneksi, "SELECT sum(transaksi_nominal) as total_cicilan FROM transaksi WHERE transaksi_jenis='Cicilan'");
          $c = mysqli_fetch_assoc($cicilan);
          ?>
          <h4 style="font-weight: bolder"><?php echo "Rp. " . number_format($c['total_cicilan']) . " ,-" ?></h4>
          <p>Seluruh Cicilan</p>
      ...
      <section class="col-lg-8">
        ...
        <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="active"><a href="#tab1" data-toggle="tab">Pemasukan, Pengeluaran & Cicilan</a></li>
          ...
          <div class="tab-content" style="padding: 20px">
            ...
            <div class="chart tab-pane active" id="tab1">
              ...
              <h4 class="text-center">Grafik Data Pemasukan, Pengeluaran & Cicilan <b>Bulan</b></h4>
              ...
              <h4 class="text-center">Grafik Data Pemasukan, Pengeluaran & Cicilan Per <b>Tahun</b></h4>
