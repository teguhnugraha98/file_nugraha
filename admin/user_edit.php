    ...
    <div class="row">
      <section class="col-lg-6 col-lg-offset-3">
        <div class="box box-info">
          ...
          <div class="box-body">
            <form action="user_update.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
              <?php
              $data = mysqli_query($koneksi, "select * from user where user_id='$id'");
              while ($d = mysqli_fetch_array($data)) {
              ?>

                <input type="hidden" class="form-control" name="id" value="<?php echo $d['user_id'] ?>">
                ...
                <div class="form-group">
                  <label>Level</label>
                  <input type="text" value="<?= $d['user_level']; ?>" class="form-control" disabled readonly>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="fotolama" id="fotolama" class="form-control" value="<?= $d['user_foto'] ?>">
                  <p>Kosong Jika tidak ingin di ganti</p>
                </div>
