    ...
    ?>
     ...
     <table border="1" style="width: 100%">
       ...
       <?php
        ...
        while ($d = mysqli_fetch_array($data)) {
          ...
          if ($d['transaksi_jenis'] == "Pemasukan") {
            ...
            $total_surplus += $d['transaksi_nominal'];
          }
        ?>
         <tr>
           <td><?php echo $no++; ?></td>
       ...
       <tr>
         ...
         <td><?php echo "Rp. " . number_format($total_cicilan) . " ,-"; ?></td>


       </tr>
       <tr>
         <th colspan="4">SALDO</th>
         <td colspan="2"><?php echo "Rp. " . number_format((+$total_pemasukan - $total_pengeluaran) - $total_cicilan) . " ,-"; ?></td>
       </tr>
     </table>
