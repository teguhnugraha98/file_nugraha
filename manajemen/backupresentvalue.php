            ...
            <section class="col-lg-12">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Filter data value</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($d = mysqli_fetch_array($data)) {
                                            ...
                                            } elseif ($d['transaksi_jenis'] == "Cicilan") {
                                                $total_pengeluaran += $d['transaksi_nominal'];
                                            }
                                        ?>
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-bold text-danger"><?php echo "Rp. " . number_format($total_cicilan) . " ,-"; ?></td>
                                        </tr>
                                        <tr>
                                            <th colspan="4" class="text-right">SALDO</th>
                                            <td colspan="2" class="text-center text-bold text-white bg-primary"><?php echo "Rp. " . number_format($total_pemasukan - $total_pengeluaran - $total_surplus) . " ,-"; ?></td>
                                            <td colspan="2" class="text-center text-bold text-white bg-primary"><?php echo "Rp. " . number_format($total_cicilan) . " ,-"; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
