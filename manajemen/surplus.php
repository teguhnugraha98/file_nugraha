    ...
    <section class="content">
        <div class="row">
            <section class="col-lg-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Laporan Data Surplus</h3>
                    </div>
                    <div class="box-body">
                        ...
                        ?>
                            ...
                            <a href="surplus-excel.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-excel-o"></i> &nbsp CETAK EXCEL</a>
                            <a href="surplus_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
